...
namespace UnityStandardAssets.Vehicles.Aeroplane
{
    ...
    public class AeroplaneController : MonoBehaviour
    {
        ...
        [SerializeField] public float m_Lift = 0.002f;               // The amount of lift generated by the aeroplane moving forwards.
        [SerializeField] public float m_ZeroLiftSpeed = 300;         // The speed at which lift is no longer applied.
        [SerializeField] public float m_RollEffect = 1f;             // The strength of effect for roll input.
        [SerializeField] public float m_PitchEffect = 1f;            // The strength of effect for pitch input.
        [SerializeField] public float m_YawEffect = 0.2f;            // The strength of effect for yaw input.
        [SerializeField] public float m_BankedTurnEffect = 0.5f;     // The amount of turn from doing a banked turn.
        [SerializeField] public float m_AerodynamicEffect = 0.02f;   // How much aerodynamics affect the speed of the aeroplane.
        [SerializeField] public float m_AutoTurnPitch = 0.5f;        // How much the aeroplane automatically pitches when in a banked turn.
        [SerializeField] public float m_AutoRollLevel = 0.2f;        // How much the aeroplane tries to level when not rolling.
        [SerializeField] public float m_AutoPitchLevel = 0.2f;       // How much the aeroplane tries to level when not pitching.
        [SerializeField] public float m_AirBrakesEffect = 3f;        // How much the air brakes effect the drag.
        [SerializeField] public float m_ThrottleChangeSpeed = 0.3f;  // The speed with which the throttle changes.
