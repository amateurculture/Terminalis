...
public class ChangeClothing : MonoBehaviour
{
    ...
    private void Start()
    {
        if (avatar == null) avatar = GameObject.FindGameObjectWithTag("Player").GetComponent<DynamicCharacterAvatar>();
    }
    ...
    {
        var buttons = transform.parent.GetComponent<MirrorMenu>().buttonList;
