...
public class CarAudio1 : MonoBehaviour
{
    ...
    public WheelDrive1 m_CarController; // Reference to car we are controlling
    ...
    private void StartSound()
    {
        ...
        m_CarController = GetComponent<WheelDrive1>();
    ...
    private void Update()
    {
        ...
        if (m_StartedSound)
        {
            ...
            float pitch = ULerp(lowPitchMin, lowPitchMax, 2); //
            ...
            else
            {
                ...
                var accelInput = (rigidbody1.velocity.magnitude - blackBox.oldVelocity) / Time.fixedDeltaTime; 

                float accFade = Mathf.Abs(accelInput);
                float decFade = 1 - accFade;

                // get the high fade value based on the cars revs
                float highFade = Mathf.InverseLerp(0.2f, 0.8f, 2); //m_CarController.Revs
