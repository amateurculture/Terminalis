...
public class SunController : MonoBehaviour
{
    ...
    void Update()
    {
        // todo this is so kludgy, why is the reflection probe rendering at a really odd and specific time?
        if ((isFirstTime && Time.frameCount % 16 == 0) || (Time.frameCount % reflectionFrameSkip == 0 && reflectionProbe != null))
        {
            isFirstTime = false;
    ...
    void UpdateSunLight()
    {
        if (RenderSettings.sun == null) RenderSettings.sun = GetComponent<Light>();
